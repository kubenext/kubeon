...
import (
	...
	"github.com/kubenext/kubeon/pkg/icon"
	"github.com/kubenext/kubeon/pkg/store"
	corunstructured "github.com/kubenext/kubeon/thirdparty/unstructured"
...
func CustomResourceDefinitions(ctx context.Context, o store.Store) ([]*apiextv1beta1.CustomResourceDefinition, bool, error) {
	...
	for i := range rawList.Items {
		...
		if err := corunstructured.DefaultUnstructuredConverter.FromUnstructured(rawList.Items[i].Object, crd); err != nil {
