...
//go:generate mockgen -source=namespace.go -destination=./fake/mock_namespace_interface.go -package=fake github.com/kubenext/kubeon/internal/cluster NamespaceInterface
...
func namespaces(di dynamic.Interface) ([]corev1.Namespace, error) {
