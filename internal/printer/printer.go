...
import (
	...
	"github.com/kubenext/kubeon/internal/config"
	"github.com/kubenext/kubeon/internal/link"
	"github.com/kubenext/kubeon/pkg/plugin"
...
//go:generate mockgen -destination=./fake/mock_printer.go -package=fake github.com/kubenext/kubeon/internal/printer Printer
